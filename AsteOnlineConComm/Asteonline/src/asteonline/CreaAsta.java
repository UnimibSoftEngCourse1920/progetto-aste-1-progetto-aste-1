    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            if(tipo == 0){
                ...
                t = "0"; //fare controllo nella selezione della query che se t == 0 a durata_timeslot assegno t, se e' diverso da 0 a durata_timeslot assegno tipo
            }
            ...
            String data=String.valueOf(anno).toString()+"/"+String.valueOf(mese).toString()+"/"+String.valueOf(giorno).toString();
            ...
            // query per cambiare il valore stato dell'oggeto da 0 a 1
