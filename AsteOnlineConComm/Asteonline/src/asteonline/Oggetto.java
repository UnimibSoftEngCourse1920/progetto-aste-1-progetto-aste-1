...
public class Oggetto extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
           int v = Integer.parseInt(nome);      //serve per verificare se l'utente ha inserito solo numeri
           inserisci1 = false;                    //(ammetto che un utente può inserire numeri nei nomi degli oggetti)
       ...
       try{
           double q = Double.parseDouble(prez);   //serve per verificare se l'utente ha inserito solo numeri nel prezzo
           //int q = Integer.parseInt(prez);      //serve per verificare se l'utente ha inserito solo numeri nel prezzo
           ins2 = true; 
           if(q<0){
               ins2=false;
           }
       ...
       //controllo per verfificare che gli inserimenti siano stai fatti nel modo corretto
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        hm.setAstaPart(asta_partecipante);
         try {
             ...
             Logger.getLogger(Oggetto.class.getName()).log(Level.SEVERE, null, ex);
         }
