...
public class Aste extends javax.swing.JFrame {
     ...
     double off = 0;
     int numOffMax = 0;
     double offPmax = 0; // variabile offerta personale usata per aste tipo 1 BUSTA CHIUSA
    ...
    public void setSaldodisp(double saldodisponibile){
        ...
        jLabel11.setText(this.saldodisponibile+ " euro");
    }
    ...
    public void AggiornamentoGuiTipoChiuso(int offerte_rim, double saldodisp, double offPersonale){
        jLabel11.setText(String.valueOf(saldodisp).toString());
        jLabel9.setText(String.valueOf(offerte_rim).toString());
        jLabel6.setText(String.valueOf(offPersonale).toString());
    }
            ...
            if(tipA == 0){ // classica
                ...
                if(id_asta == astP){ //controllo se l'utente sta gia partecipando a questa offerta
                    if(id_utente == utOfMax){//se l'utente e' quello con l'offerta max assegno offmax
                        ...
                        offPmax = saldotot - saldodisponibile; //altrimenti metto la sottrazione tra saldo totale e saldo disponibile(questo perche' puo' partecipare solo ad un asta alla volta)
                        jLabel6.setText(String.valueOf(offPmax));
                    }
                }else{
                    offPmax = 0;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       // controllo che l'offerta inserita sia corretta(solo numeri)
        boolean isNum = false;
        ...
        //controllo che l'offerta fatta non sia maggiore del saldo disponibile
        if(off > saldodisponibile){
            numRight = false;
            jLabel15.setVisible(true);
        }
        //controllo se l'asta e' APERTA (tipo_asta = 0)
