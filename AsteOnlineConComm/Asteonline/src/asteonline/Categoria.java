...
public class Categoria extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
           int v = Integer.parseInt(prova);      //serve per verificare se l'utente ha inserito solo numeri
           inserisci = false;                    //(ammetto che un utente può inserire numeri nei nomi della categoria)
       }catch(Exception e){
